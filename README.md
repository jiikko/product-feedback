...
## 記入してほしい内容 / What to Include

- 対象プロダクト / Product name
- アプリバージョン / App version
- OSバージョン / 端末名 / OS version / Device name
- 再現手順 / Steps to reproduce
- 期待した結果 / Expected result
- 実際の結果 / Actual result
- （可能なら）スクリーンショットや動画 / Screenshots or videos (if possible)
...
We review all submissions, but may not be able to respond to every one.
Bug fixes are generally prioritized over feature requests.
